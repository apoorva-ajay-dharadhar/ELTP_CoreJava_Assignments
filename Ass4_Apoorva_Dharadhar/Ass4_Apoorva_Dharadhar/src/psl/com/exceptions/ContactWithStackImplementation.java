...
//import com.psl.assignment.four.Trial;
...
public class ContactWithStackImplementation {
	static int top=0;
	...
	//}
	public static void push(ContactWithStackImplementation t, ContactWithStackImplementation[] arr ) throws NewStackException
	{
	...
	public static void pop(ContactWithStackImplementation t) throws NewStackException 
	{
	...
	public static void main(String[] args) throws NewStackException 
	{
		...
		ContactWithStackImplementation[] tr=new ContactWithStackImplementation[2];
		...
		for(int i=0;i<2;i++)
		{
			...
			try
			{
					...
					if(isValid)
					{
					   ...
					   //tr[i]=new ContactWithStackImplementation();
					   ContactWithStackImplementation cs=new ContactWithStackImplementation();
						cs.setName(firstName);//tr[i]
		...
		try
		{
			ContactWithStackImplementation r=new ContactWithStackImplementation();
			/*push(r); 
